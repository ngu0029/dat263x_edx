...
print(""" 1. Normalize text, remove stop words, and stem """)
...
print(""" 2. Feature Hashing: Hash text tokens to numeric indicator features """)
...
print(""" 3. Split the data for training and testing """)
...
print(""" 4. Train the model using two-class Boosted Decision Tree Classifier """)
